...
## Controller
Each table will have its corresponding controller. Controllers have functions, each function will have its corresponding view file. Like, function add() will have a view file names add.ctp in that corresponding view file of the corresponding table. `echo $this->Form->create('Topic');` This form named is given upon Model name corresponding to the table name.
